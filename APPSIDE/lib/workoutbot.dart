...
void main() {
  runApp(const WorkoutAssistantApp());
}

class WorkoutAssistantApp extends StatelessWidget {
  const WorkoutAssistantApp({Key? key}) : super(key: key);
...
class WorkoutAssistantScreen extends StatefulWidget {
  @override
  _WorkoutAssistantScreenState createState() => _WorkoutAssistantScreenState();
}
  ...
  Future<void> sendMessage(String message) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('$url/workbot_response'),
        headers: {
